...
import { RequestCrearRolPerfil } from 'src/app/model/request/requestCrearRolPerfilModel';
import { ResponseConsultaRol } from 'src/app/model/response/responseConsultaRolModel';
import { ResponseConsultaRolPerfil } from 'src/app/model/response/responseConsultaRolPerfilModel';
import { ResponseCrearRolPerfil } from 'src/app/model/response/responseCrearRolPerfilModel';
