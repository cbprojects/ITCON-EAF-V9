...
import { RequestConsultaUsuario } from 'src/app/model/request/requestConsultaUsuarioModel';
import { ResponseConsultaUsuario } from 'src/app/model/response/responseConsultaUsuarioModel';
