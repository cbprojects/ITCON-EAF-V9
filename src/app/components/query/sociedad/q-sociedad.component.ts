...
import { RequestConsultaSociedad } from 'src/app/model/request/requestConsultaSociedadModel';
import { ResponseConsultaSociedad } from 'src/app/model/response/responseConsultaSociedadModel';
