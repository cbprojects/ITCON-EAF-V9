...
import { RequestConsultaPermisosBodega } from 'src/app/model/request/requestConsultaPermisosBodegaModel';
import { RequestConsultaPrestamo } from 'src/app/model/request/requestConsultaPrestamoModel';
import { RequestConsultaUnidadDocumental } from 'src/app/model/request/requestConsultaUnidadDocumentalModel';
import { RequestModificarPrestamo } from 'src/app/model/request/requestModificarPrestamoModel';
import { RequestSociedadXCliente } from 'src/app/model/request/requestSociedadXCliente';
import { ResponseConsultaUnidadDocumental } from 'src/app/model/response/responseConsultaUnidadDocumentalModel';
import { ResponseModificarPrestamo } from 'src/app/model/response/responseModificarPrestamo';
import { ResponsePrestamo } from 'src/app/model/response/responsePrestamoModel';
