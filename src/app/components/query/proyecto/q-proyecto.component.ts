...
import { RequestConsultaProyecto } from 'src/app/model/request/requestConsultaProyecto';
import { RequestConsultaSociedadArea } from 'src/app/model/request/requestConsultaSociedadAreaModel';
import { RequestSociedadXCliente } from 'src/app/model/request/requestSociedadXCliente';
import { ResponseConsultaProyecto } from 'src/app/model/response/responseConsultaProyectoModel';
import { ResponseConsultaSociedadArea } from 'src/app/model/response/responseConsultaSociedadAreaModel';
