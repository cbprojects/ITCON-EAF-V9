...
import { RequestConsultaCaja } from 'src/app/model/request/requestConsultaCajaModel';
...
import { ResponseConsultaCaja } from 'src/app/model/response/responseConsultaCajaModel';
