...
import { RequestConsultaBodega } from 'src/app/model/request/requestConsultaBodegaModel';
import { ResponseConsultaBodega } from 'src/app/model/response/responseConsultaBodegaModel';
